          ...
          <div className="space-y-8 sticky top-24">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary font-medium text-sm mb-6 border border-primary/20">
                ...
                <Translate>Every rupee creates impact</Translate>
              </div>
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold font-heading mb-4 leading-tight">
                <Translate>Your Support</Translate> <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-emerald-500 to-teal-500">
                  <Translate>Saves Lives</Translate>
                </span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                <Translate>Join our community of 12,000+ donors and make a lasting impact. Your donation goes directly to those who need it most — providing food, education, and medical care to families across India.</Translate>
              </p>
            </div>
            {}
            <div className="bg-background rounded-[2rem] p-8 border border-border shadow-sm">
              <h3 className="text-xl font-bold font-heading mb-6"><Translate>Why give to HopeBridge?</Translate></h3>
              <ul className="space-y-5">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4 text-muted-foreground group">
                    ...
                    <span className="leading-relaxed"><Translate>{item.text}</Translate></span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary/5 to-emerald-500/5 rounded-[2rem] p-6 border border-primary/10">
              <div className="flex items-center gap-4 mb-3">
                ...
                <p className="text-sm font-medium text-foreground/80">
                  <span className="font-bold text-primary">127 <Translate>people</Translate></span> <Translate>donated in the last 24 hours</Translate>
                </p>
              </div>
            </div>
          </div>
